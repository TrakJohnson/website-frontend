...
export class PoleService {
  ...
  IDToPole = new Map([
    [1, "Bureau"], [2, "Pôle Alternatif"], [3, "Pôle Classique"], [4, "Pôle Ciné"], [5, "Pôle Comédie Musicale"],
    [6, "Pôle Sorties/Expos/Arts du spectacle"], [7, "Pôle Culinaire"], [8, "Pôle Jam-Jazz"], [9, "Pôle Littérature"],
    [10, "Pôle Opéra/Ballet"], [11, "Pôle Théâtre/Stand Up"], [12, "Pôle Salle Ins/Salle Piano"], [13, "Pôle Radio"],
    [14, "Pôle Rap"], [15, "Pôle Mode"], [16, "Pôle Stand-up"], [17, "Pôle Comm'"], [18, "Pôle RSI"]]
  )
  ...
  PoleForView = [
    ...
    {value: '11', viewValue: 'Pôle théatre/Stand Up'},
