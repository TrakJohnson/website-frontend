      ...
      if (dateFermeture < dateOuverture ) {
        ...
        if (this.filePath.length > 500000) { //TODO condition exacte à trouver
          ...
          .then((response:any)=>{
            ...
            this.event.createEvent(titre, description, date, lieu, this.resized_filePath, idPole, this.createurid, dateOuverture, dateFermeture, nPlaces, prixC, prixNC, points, true)
              .then((response) => {
                this.popup.loading$.next(false);
